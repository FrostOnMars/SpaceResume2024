...
using SpaceResume.Properties;

// NOTE: this class was used for a previous version of the project. 
// I will be using Postgres as part of a class for learning SQL,
// so I need to rewrite this class using Npgsql.
