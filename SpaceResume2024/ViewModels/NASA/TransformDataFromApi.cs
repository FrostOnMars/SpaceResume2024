...
{
    // ==SUMMARY==
    // Data from the API have sizes too large to be displayed on a screen.
    // This class scales the data to fit the screen.
    // This data will be used for ellipse and animation logic.
